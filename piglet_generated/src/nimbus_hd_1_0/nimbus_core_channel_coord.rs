...
impl NimbusCoreChannelCoord {
    ...
    pub async fn get_y_home_offsets(&self) -> Result</* y_home_offsets= */ Vec<i16>, Error> {
        let mut args = BytesMut::new();
        let (count, mut stream) = self
            .robot
        ...
        let y_home_offsets = Vec::<i16>::deserialize(&mut stream)?;
        Ok(y_home_offsets)
    }
    ...
    pub async fn get_z_positions(&self) -> Result</* z_positions= */ Vec<i16>, Error> {
        let mut args = BytesMut::new();
        let (count, mut stream) = self
            .robot
        ...
        let z_positions = Vec::<i16>::deserialize(&mut stream)?;
        Ok(z_positions)
    }
    ...
    pub async fn get_z_home_offsets(&self) -> Result</* z_home_offsets= */ Vec<i16>, Error> {
        let mut args = BytesMut::new();
        let (count, mut stream) = self
            .robot
        ...
        let z_home_offsets = Vec::<i16>::deserialize(&mut stream)?;
        Ok(z_home_offsets)
    }
    ...
    pub async fn get_z_default_speed(&self) -> Result<GetZDefaultSpeedReply, Error> {
        ...
        let speed = Vec::<i16>::deserialize(&mut stream)?;
    ...
    pub async fn calibrate_dispense_check(
        ...
        let steps = Vec::<i16>::deserialize(&mut stream)?;
        Ok(steps)
    }
    ...
    pub async fn get_y_positions(&self) -> Result</* y_positions= */ Vec<i16>, Error> {
        let mut args = BytesMut::new();
        let (count, mut stream) = self
            .robot
        ...
        let y_positions = Vec::<i16>::deserialize(&mut stream)?;
        Ok(y_positions)
    }
